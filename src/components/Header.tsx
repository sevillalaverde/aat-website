    ...
    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="https://x.com/aait_ai"
            target="_blank"
            rel="noreferrer"
            aria-label="X (Twitter)"
            title="X (Twitter)"
            className="p-1.5 rounded text-neutral-700 hover:text-black hover:bg-neutral-100"
          >
            <IconX />
          </a>
          <a
            href="https://t.me/american_aat"
            target="_blank"
            rel="noreferrer"
            aria-label="Telegram"
            title="Telegram"
          ...
          <a
            href="https://discord.gg/sC84NN33"
            target="_blank"
            rel="noreferrer"
            aria-label="Discord"
            title="Discord"
